...
# load dataset
pima = pd.read_csv("Amna-AI-Course-Bin/auto-mpg[1].csv", header=1, names=col_names)

#split dataset in features and target variable
feature_cols = ['cylinders', 'displacement', 'acceleration', 'weight','origin','mpg','horsepower']
