...
# Load CSV dataset
# =====================================
dataset = pd.read_csv("Amna-AI-Course-Bin/sundanese+twitter+dataset/data.csv" )   # <-- change path if needed
...
# =====================================
X = dataset['data'].copy()     # Feature (TEXT)
y = dataset['label'].copy()    # Target (1–5)
