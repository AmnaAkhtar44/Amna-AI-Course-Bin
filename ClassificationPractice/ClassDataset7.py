...
# Load CSV dataset
# =====================================
dataset = pd.read_csv("Amna-AI-Course-Bin/recipe+reviews+and+user+feedback+dataset/Recipe Reviews and User Feedback Dataset.csv" )   # <-- change path if needed
...
# =====================================
dataset = dataset[['text', 'best_score']]
...
# =====================================
X = dataset['text'].copy()     # Feature (TEXT)
y = dataset['best_score'].copy()    # Target (1–5)
