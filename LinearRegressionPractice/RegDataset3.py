...
df.plot.scatter(x='displacement', y='acceleration', title='Scatter Plot of displacement and acceleration percentages')
plt.show()
...
print("  df['acceleration']   :    ", df['acceleration']   )
...
print(df['acceleration'].values) # [2.5 5.1 3.2 8.5 3.5 1.5 9.2 ... ]
print(df['acceleration'].values.shape) # (25,)
...
acceleration = calc(regressor.coef_, regressor.intercept_, 9.5)
print(acceleration) # [[94.80663482]]
acceleration = regressor.predict([[9.5]])
print(acceleration) # 94.80663482
