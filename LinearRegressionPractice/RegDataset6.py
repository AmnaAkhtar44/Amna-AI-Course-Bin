...
print(df['age'].values) # [2.5 5.1 3.2 8.5 3.5 1.5 9.2 ... ]
print(df['age'].values.shape) # (25,)
...
charges = calc(regressor.coef_, regressor.intercept_, 9.5)
print(charges) # [[94.80663482]]
charges = regressor.predict([[9.5]])
print(charges) # 94.80663482
